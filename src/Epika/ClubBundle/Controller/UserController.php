...
use Epika\ClubBundle\Entity\User;
use Epika\ClubBundle\Form\UserType;
...
class UserController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EpikaClubBundle:User')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EpikaClubBundle:User')->find($id);
     ...
     * @Method("post")
     * @Template("EpikaClubBundle:User:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("EpikaClubBundle:User:edit.html.twig")
     */
